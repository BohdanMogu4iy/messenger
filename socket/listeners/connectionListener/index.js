...
const {getAllUserPersonalChats, getAllOnlineUserChats} = require("../../../models/Chat");
...
const connectionListener = io => {
    return async socket => {
        ...
        await getAllOnlineUserChats(socket.userId)
            .then(chatList => {
                socket.emit(events.CHATS_ONLINE, chatList)
            })
